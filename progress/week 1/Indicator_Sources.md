...
| Consumer Price Inflation                                 | `Trading Economics` | `Inflation`              | `INF_USA`           | %                | Monthly   | TE     |
...
| Recession Indicators *(NBER)*                            | `USREC`             | `Recession_Indicator`    | `RECESS_USA`        | Binary (0/1)     | Monthly   | FRED   |
...
| Nominal GDP                                              | `NGDPSAXDCUSQ`      | `Nominal_GDP`            | `NGDP_USA`          | Millions USD     | Quarterly | FRED   |
| Population                                               | `POPTHM`            | `Population_USA`         | `POP_USA`           | Millions         | Monthly   | FRED   |

*All the billion unit have been converted to millions
...
| Industrial Production (Excl. Construction) for Japan | `JPNPROINDAISMEI`     | `Industrial_Production`   | `IP_JAP`              | Index (2015 = 100) | Monthly   | FRED       |
...
| Inflation, consumer prices                           | `Trading Economics`   | `Inflation`               | `INF_JAP`             | %                  | Monthly   | TE         |
...
| OECD-based Recession Indicators *(DISCONTINUED)*     | `JPNRECDM`            | `Recession_Indicator`     | `RECESS_JAP`          | Binary (0/1)       | Monthly   | FRED       |
| Real Gross Domestic Product for Japan                | `JPNRGDPEXP`          | `Real_GDP`                | `GDP_JAP`             | Billions JPY*      | Quarterly | FRED       |
| Real GDP per Capita *(DISCONTINUED)*                 | `JPNRGDPC`            | `Real_GDP_Per_Capita`     | `GDPC_JAP`            | USD                | Annual    | FRED       |
...
### Link sources:
* Inflation: https://tradingeconomics.com/japan/inflation-cpi
...
| Index of Industrial Production for Germany             | `DEUPROINDMISMEI`  | `Industrial_Production`     | `IP_GER`        | Index (2015 = 100) | Monthly   | FRED       |
...
| Inflation, consumer prices for Germany                 | `CPALTT01DEM657N`  | `Inflation`                 | `INF_GER`       | %                  | Monthly   | TE         |
| Unemployment to Population Rate: All Ages: All Persons | `LRUPTTTTDEQ156S`  | `Unemployment_Rate`         | `UNEMP_GER`     | %                  | Quarterly | FRED       |
| Real Imports of Goods and Services in Germany          | `NMRSAXDCDEQ`      | `Real_Imports`              | `IM_GER`        | Millions EUR       | Quarterly | FRED       |
| Exports of Goods and Services in Germany               | `DEUEXPORTQDSNAQ`  | `Real_Exports`              | `EX_GER`        | EUR                | Quarterly | FRED       |
| OECD-based Recession Indicator *(DISCONTINUED)*        | `DEURECDM`         | `Recession_Indicator`       | `RECESS_GER`    | Binary (0/1)       | Monthly   | FRED       |
| Real Gross Domestic Product for Germany                | `CLVMNACSCAB1GQDE` | `Real_GDP`                  | `GDP_GER`       | Millions EUR       | Quarterly | FRED       |
| Real GDP per capita                                    | `DEURGDPC`         | `Real_GDP_Per_Capita`       | `GDPC_GER`      | USD                | Annual    | FRED       |
...
| Production: Industry: Total Industry Excluding Construction for China | `CHNPRINTO01IXPYM` | `Industrial_Production`    | `IP_CHI`              | Index (Same period previous year = 100) | Monthly   | FRED          |
...
| Real Imports of Goods and Services for China                          | `NMRXDCCNA`        | `Real_Imports`             | `IM_CHI`              | CNY                                     | Annual    | FRED          |
| Real Exports of Goods and Services for China                          | `NXRXDCCNA`        | `Real_Exports`             | `EX_CHI`              | CNY                                     | Annual    | FRED          |
| OECD-based Recession Indicator *(DISCONTINUED)*                       | `CHNRECDM`         | `Recession_Indicator`      | `RECESS_CHI`          | Binary (0/1)                            | Monthly   | FRED          |
| Real Gross Domestic Product for China                                 | `NGDPRXDCCNA`      | `Real_GDP`                 | `GDP_CHI`             | Millions CNY                            | Annual    | FRED          |
...
| Production: Industry: Total Industry Excluding Construction for Canada | `CANPROINDMISMEI`   | `Industrial_Production` | `IP_CAN`             | Index   (2015 = 100) | Monthly   | FRED           |
...
| Inflation, consumer prices for Canada                                  | `Trading Economics` | `Inflation`             | `INF_CAN`            | %                    | Monthly   | TE             |
| Unemployment Rate for Canada                                           | `LRUNTTTTCAM156S`   | `Unemployment_rate`     | `UNEMP_CAN`          | %                    | Monthly   | FRED           |
| Real Exports of Goods and Services for Canada                          | `NXRSAXDCCAQ`       | `Real_Exports`          | `EX_CAN`             | Millions CAD         | Quarterly | FRED           |
| Real Imports of Goods and Services for Canada                          | `NMRSAXDCCAQ`       | `Real_Imports`          | `IM_CAN`             | Millions CAD         | Quarterly | FRED           |
| OECD-based Recession Indicators for Canada *(DISCONTINUED)*            | `CANRECDM`          | `Recession_Indicator`   | `RECESS_CAN`         | Binary (0/1)         | Monthly   | FRED           |
| Real Gross Domestic Product for Canada                                 | `NGDPRSAXDCCAQ`     | `Real_GDP`              | `GDP_CAN`            | Millions CAD         | Quarterly | FRED           |
| Real GDP per capita *(DISCONTINUED)*                                   | `CANRGDPC`          | `Real_GDP_Per_Capita`   | `GDPC_CAN`           | US                   | Annual    | FRED           |
...
| Production: Industry: Total Industry Including Construction for Mexico | `MEXPRINTO02IXOBSAM` | `Industrial_Production`    | `IP_MEX`              | Index (2015 = 100) | Monthly   | FRED       |
...
| Inflation, consumer prices for Mexico                                  | `Trading Economics`  | `Inflation`                | `INF_MEX`             | %                  | Monthly   | TE         |
| Unemployment Rate for Mexico                                           | *LRHUTTTTMXM156S*    | `Unemployment_Rate`        | `UNEMP_MEX`           | %                  | Monthly   | FRED       |
| Recession Indicator                                                    | `MEXRECDM`           | `recession_indicator`      | `RECESS_MEX`          | Binary (0/1)       | Monthly   | FRED       |
| Real Gross Domestic Product for Mexico                                 | `NGDPRSAXDCMXQ`      | `Real_GDP`                 | `GDP_MEX`             | Millions MXN       | Quarterly | FRED       |
| Real GDP per capita                                                    | `NY.GDP.PCAP.CD`     | *(custom)*                 | `GDPC_MEX`            | USD                | Annual    | World Bank |
| Real Exports of Goods and Services for Mexico                          | `NXRSAXDCMXQ`        | `Real_Exports`             | `EX_MEX`              | Millions MXN       | Quarterly | FRED       |
| Real Imports of Goods and Services for Mexico                          | `NMRSAXDCMXQ`        | `Real_Imports`             | `IM_MEX`              | Millions MXN       | Quarterly | FRED       |
